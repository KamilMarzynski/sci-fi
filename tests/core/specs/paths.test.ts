...
import { buildFeatureDirectoryPath, buildFeatureMetadataPath, buildFeaturesRootPath } from "../../../src/core/specs/paths.js";

describe("spec path helpers", () => {
  it("builds features root path", () => {
    expect(buildFeaturesRootPath("/repo")).toBe(
      join("/repo", "docs", "specflow", "specs"),
    );
  });
