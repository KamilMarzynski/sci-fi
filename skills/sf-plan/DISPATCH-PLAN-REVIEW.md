...
feature directory returned by `specflow plan` (e.g.
`docs/specflow/specs/<slug>`). The review criteria and output format live in the
...
{FEATURE_PATH}/tasks/, plus docs/specflow/ARCHITECTURE.md and
docs/specflow/CONTEXT.md, then return your report and verdict exactly as the
