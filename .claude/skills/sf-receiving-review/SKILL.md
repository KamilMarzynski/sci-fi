---
name: sf-receiving-review
description: How to act on a review (spec, plan, or code). Verify before
  implementing, fix by severity, push back with technical reasoning when the
  reviewer is wrong.
---
# sf-receiving-review
